...
/**
 * This file contains the unittests for steps's scss compilation.
 *
 * @package   theme_steps
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_steps_scss_testcase extends advanced_testcase {
    /**
     * Test that steps can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('steps')->get_css_content_debug('scss', null, null)
        );
    }
}
