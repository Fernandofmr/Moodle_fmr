...
use \theme_steps\privacy\provider;

/**
 * Unit tests for theme_steps/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_steps_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_steps');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_steps'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_steps'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
