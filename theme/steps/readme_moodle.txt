...
* remove folder theme/steps/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/steps/scss/bootstrap
...
* comment out this line in theme/steps/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/steps/amd/src/bootstrap (including the subfolder)
...
* in folder theme/steps run "Grunt amd" to compile the bootstrap JS
